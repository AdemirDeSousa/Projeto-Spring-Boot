...
public class ClienteService {
	...
	public Cliente fromDTO(ClienteNewDTO objDTO) {
		Cliente cliente = new Cliente(null, objDTO.getNome(), objDTO.getEmail(), objDTO.getCpf_ou_cnjp(), TipoCliente.toEnum(objDTO.getTipo_cliente()), encoder.encode(objDTO.getSenha()));
